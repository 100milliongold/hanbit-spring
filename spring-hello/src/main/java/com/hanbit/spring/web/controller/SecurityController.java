...
public class SecurityController {
	...
	public String signin(HttpSession session, HttpServletResponse res ) throws Exception{
	...
	public void doSignout(HttpSession session,HttpServletResponse res) throws Exception{
		session.invalidate();
